  ...
  return (
    <section ref={ref} className="bg-muted/50 dark:bg-muted/15 border-t py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          <h2 className="text-foreground mb-4 text-3xl font-bold md:text-4xl">Общи статистики</h2>
          <p className="text-muted-foreground mx-auto max-w-4xl text-base md:text-lg">
            Разгледайте статистики за нашата платформа и потребителската активност.
          </p>
        </motion.div>
