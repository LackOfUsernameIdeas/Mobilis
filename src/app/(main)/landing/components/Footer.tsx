...
import { pages, techStack } from "../constants";

const Footer = () => (
  <Fragment>
    <footer className="bg-card mt-auto border-t py-6">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="mb-10 grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="space-y-4">
            <h3 className="text-foreground text-lg font-semibold">За Нас</h3>
            <div className="text-muted-foreground space-y-2 text-sm">
              <p>Проект №734</p>
              <Link
                className="hover:text-primary relative inline-block transition-colors after:absolute after:bottom-0 after:left-0 after:h-px after:w-full after:origin-left after:scale-x-0 after:bg-current after:transition-transform after:duration-300 hover:after:scale-x-100"
            ...
            <div className="pt-2">
              <h3 className="text-foreground mb-3 text-lg font-semibold">Изработено от</h3>
              <div className="text-muted-foreground space-y-1 text-sm">
                <p>Калоян Костадинов</p>
                <p>Ивайло Здравков</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-foreground text-lg font-semibold">Използвани Технологии</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-foreground text-lg font-semibold">Страници</h3>
          ...
          <div className="flex items-center justify-center lg:justify-end">
            <svg
              ...
              viewBox="0 0 400 180"
              className="text-foreground h-auto max-h-full w-full max-w-full"
            >
              <path
        ...
        <div className="border-muted-foreground/20 my-6 border-t"></div>

        <div className="text-muted-foreground text-center text-xs">
          <Link
            className="hover:text-primary relative italic transition-colors after:absolute after:bottom-0 after:left-0 after:h-px after:w-full after:origin-left after:scale-x-0 after:bg-current after:transition-transform after:duration-300 hover:after:scale-x-100"
            href="https://edusoft.fmi.uni-sofia.bg/"
          >
            23-та Национална Олимпиада по Информационни Технологии
          </Link>{" "}
          - 2026 г. -{" "}
          <Link
            className="hover:text-primary relative italic transition-colors after:absolute after:bottom-0 after:left-0 after:h-px after:w-full after:origin-left after:scale-x-0 after:bg-current after:transition-transform after:duration-300 hover:after:scale-x-100"
