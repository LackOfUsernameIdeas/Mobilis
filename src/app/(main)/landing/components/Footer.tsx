      ...
      <footer ref={ref} className="bg-card mt-auto border-t py-6">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="border-muted-foreground/20 my-6 border-t"
          ></motion.div>
          ...
          >
            <Link className="hover:text-primary italic transition-colors" href="https://edusoft.fmi.uni-sofia.bg/">
              23-та Национална Олимпиада по Информационни Технологии
            </Link>{" "}
            - 2026 г. -{" "}
            <Link className="hover:text-primary italic transition-colors" href="https://pgi-pernik.bg-schools.com/">
