...
const CONFIG = {
  workout: {
    ...
    icon: Dumbbell,
    intro: "Създайте персонализиран тренировъчен план, за да можете да проследявате тренировките си по дни.",
    points: [
    ...
    cta: "Създайте тренировъчен план",
  },
  meal: {
    ...
    intro:
      "Създайте персонализиран хранителен план, за да можете да следите дневния си прием на хранителни показатели.",
    points: [
