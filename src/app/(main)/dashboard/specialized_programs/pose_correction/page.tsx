...
const exercises = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Връщане в неутрална позиция - 3 секунди (między движенията)",
    ],
  },
  {
    id: 3,
  ...
  return (
    <div className="bg-background @container/main flex min-h-screen flex-col gap-6 p-6 md:gap-8 md:p-10 lg:p-12">
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.3, delay: 0.1, ease: [0.21, 0.47, 0.32, 0.98] }}
      >
        <Card className="border-blue-200 bg-blue-50 dark:border-blue-900/50 dark:bg-blue-950/50">
          <CardContent className="space-y-3 text-sm leading-relaxed text-blue-800 dark:text-blue-300">
            <p>
              Упражненията са резултат от анализ и консултации с физиотерапевти, с цел изграждане на логично
              структурирана тренировъчна програма. Подходът цели да се справи с натоварванията и ограниченията на
              тялото, като програмата е насочена към конкретни нужди и цели, а именно:
            </p>
      ...
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.3, delay: 0.3, ease: [0.21, 0.47, 0.32, 0.98] }}
      >
        <Card className="border-blue-200 bg-blue-50 dark:border-blue-900/50 dark:bg-blue-950/50">
          <CardHeader>
          ...
          <CardContent className="space-y-4 text-sm leading-relaxed text-blue-800 dark:text-blue-300">
            <p className="mb-4">
              Приложението работи с камерата <strong>Orbbec Astra+</strong> и следи за правилното изпълнение на всяка
              една от стъпките за съответните упражнения в реално време, с помощта на гласов асистент, като сравнява
              движенията на потребителя с правилната техника за всяко от тях.
            </p>
      ...
      <motion.div
        ...
        transition={{ duration: 0.3, delay: 0.35, ease: [0.21, 0.47, 0.32, 0.98] }}
      >
        <Alert
          variant="destructive"
        ...
        >
          ...
          <AlertDescription className="leading-relaxed text-pretty">
            ...
            консултации, но може да е необходима преоценка от специалист, за да се адаптират към индивидуалните ви
            нужди. В никакъв случай не поощряваме прескачането на лекарска препоръка.
          </AlertDescription>
        </Alert>
      </motion.div>
