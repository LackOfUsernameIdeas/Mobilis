...
export const EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    bgName: "Странични наклонения на врата",
    difficulty: "Лесно",
...
export const ABOUT_TEXT = {
  intro:
    "Упражненията са резултат от анализ и консултации с кинезитерапевти, с цел изграждане на логично структурирана тренировъчна програма. Подходът цели да се справи с натоварванията и ограниченията на тялото, като програмата е насочена към конкретни нужди и цели, а именно:",
  goals: [
...
export const WARNING_TEXT =
  "Подбирането на тези упражнения е осъществено съвместно с кинезитерапевти, в следствие на достатъчно консултации, но може да е необходима преоценка от специалист, за да се адаптират към индивидуалните ви нужди. В никакъв случай не поощряваме прескачането на лекарска препоръка.";
