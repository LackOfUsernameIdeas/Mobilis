  ...
  if (category === "gym") {
    return `Създай персонализирана седмична фитнес програма за потребител със следните характеристики:
      ...
      **КРИТИЧНО ВАЖНО - ЗАДЪЛЖИТЕЛНИ ПРАВИЛА ЗА ЕЗИК И ФОРМАТ:**
      ...
      - focus: ВИНАГИ на БЪЛГАРСКИ (например: "Горна част на тялото (натискащи + дърпащи упражнения)", "Долна част на тялото + коремни мускули")
    ...
    return `Създай персонализирана седмична калистенична програма за потребител със следните характеристики:
      ...
      **КРИТИЧНО ВАЖНО - ЗАДЪЛЖИТЕЛНИ ПРАВИЛА ЗА ЕЗИК И ФОРМАТ:**
      - day: ВИНАГИ използвай формат "Ден 1", "Ден 2", "Ден 3", "Ден 4" и т.н. (НИКОГА "Day 1", "Day 2")
      - focus: ВИНАГИ на БЪЛГАРСКИ (например: "Горна част на тялото - натискащи упражнения", "Долна част на тялото и коремни мускули")
      - warmup.exercises: ВСИЧКИ упражнения и обяснения САМО на БЪЛГАРСКИ (например: "5 минути бързо ходене или джогинг на място", "Кръгови движения с раменете", "Леки котрапулки")
      - cooldown.exercises: ВСИЧКИ упражнения и обяснения САМО на БЪЛГАРСКИ (например: "Статично разтягане на гърдите", "Разтягане на бицепсите и раменете")
      - safety_considerations: ДО 3 съвета и ВСИЧКИ да са на български`;
  } else if (category === "yoga") {
    return `Създай персонализирана седмична йога програма за потребител със следните предпочитания:
      ...
      **Ниво на опит:**
      ...
      - При базово ниво включвай основни пози с правилна техника и леки вариации
      ...
      **КРИТИЧНО ВАЖНО - ЗАДЪЛЖИТЕЛНИ ПРАВИЛА ЗА ЕЗИК И ФОРМАТ:**
      ...
      - warmup.exercises: ВСИЧКИ упражнения и обяснения САМО на БЪЛГАРСКИ (например: "Центриране и медитация (1-2 минути)", "Дишателни техники - дълбоко коремно дишане (2-3 минути)", "Слънчеви поздрави (Сурия Намаскар) - 3-5 цикъла")
    ...
    return `Създай персонализирана седмична програма за бягане за потребител със следните характеристики:
      ...
      **Нива на опит:**
      ...
      - При базово ниво включвай непрекъснато бягане, 3-5 км дистанции, бързо темпо, въвеждане на лек fartlek
      ...
      **Терен:**
      ...
      - При 'бягаща пътека' давай точни настройки за наклон и скорост (km/h темпо), контролирана среда
      ...
      **Формат на полетата:**
      ...
      - repetitions: число (8, 6, 10) или null (за continuous runs)
