  ...
  if (category === "gym") {
    ...
    return `Създай персонализирана седмична програма за бягане за потребител със следните характеристики:
      ...
      **Нива на опит:**
      ...
      - При 'basic' ниво включвай непрекъснато бягане, 3-5 км дистанции, бързо темпо, въвеждане на лек fartlek
      ...
      - При 'advanced' ниво включвай сложни тренировки, hill repeats, по-агресивни интервали (400m-1200m), fartlek, 10-15 км дистанции
